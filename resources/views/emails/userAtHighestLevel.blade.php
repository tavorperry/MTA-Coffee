                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="padding: 40px 40px 20px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                                <h1 style="margin: 0 0 10px; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal;">משתמש הגיע לרמת אלוף!</h1>
                                                ...
                                                <ul style="padding: 0; margin: 0; list-style-type: disc;">
                                                    ...
                                                    <li style="margin:0 0 10px 30px;">אנא פנו אל הסטודנט כדי להעניק לו מתנה</li>
                                                </ul>
                                                </p>
                                            </td>
                                        </tr>
